<!--Action Button-->
@if( Active::checkUriPattern( 'admin/shippings' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.shippings.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.shippings.all' ) }}
            </a>
        </li>
        @permission( 'create-shipping' )
            <!-- <li>
                <a href="{{ route( 'admin.shippings.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.shippings.create' ) }}
                </a>
            </li> -->
        @endauth
    </ul>
